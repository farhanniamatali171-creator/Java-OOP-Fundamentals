class Computer {
    ...
    public double getWordsize() { return wordsize; }
    public void setWordsize(double wordsize) { this.wordsize = wordsize; }
    public double getMemorysize() { return memorysize; }
    public void setMemorysize(double memorysize) { this.memorysize = memorysize; }
    public double getStoragesize() { return storagesize; }
    public void setStoragesize(double storagesize) { this.storagesize = storagesize; }
    ...
    public void display() {
        ...
        System.out.println("Storage size is :" + storagesize + " Gigabytes");
...
public class ComputerLabTask3 {
    public static void main(String[] args) {
        Laptop l1 = new Laptop(64.0, 512.0, 16, 3.5, 30, 20, 2, 1);
        l1.display();
    }
}
